...
//void displayall(information workers[], float &, float &, float &);
...
int main()
{
    ...
    while(again == 'y')
    {
        ...
        for(int n = 0; n < width; n++)
        {
            ...
            cout << "\n\n\tEmployee #" << (n+1) << " of " << width;
            cout << "\n\tEmployee LAST NAME: " << Employees[n].LastName
                 << "\n\tEmployee FIRST NAME: " << Employees[n].FirstName
                 << "\n\t" << Employees[n].Hours << " Hours Worked @ $" << Employees[n].Payrate << " = $" << Grosspay
                 << "\n\tTax Rate of " << Employees[n].Taxrate*100 << "%\t\t" << TaxesWithheld
        ...
        while(again == 'y')
        {
            ...
            switch(option)
            {
                ...
                case 2:
                {
                    ...
                    cout << "\n\tEmployee LAST NAME: " << Employees[index].LastName
                         << "\n\tEmployee FIRST NAME: " << Employees[index].FirstName
                         << "\n\t" << Employees[index].Hours << " Hours Worked @ $" << Employees[index].Payrate << " = $" << Grosspay
                         << "\n\tTax Rate of " << Employees[index].Taxrate*100 << "%\t\t" << TaxesWithheld
                         << "\n\tEmployee Gross Pay:\t\t$" << Netpay;
...
/*
void displayall(information workers[], float &grosspay, float &taxeswithheld, float &netpay)
{
    int width = sizeof(workers)/sizeof(information);
    for(int n = 0; n < width; n++)
        {
            //calculations(Employees, gross, Taxes, Net);
            calculations(workers, grosspay, taxeswithheld, netpay, n);
            cout << "\n\n\tEmployee #" << (n+1) << " of " << width;
            cout << "\n\tEmployee LAST NAME: " << workers[n].LastName
                 << "\n\tEmployee FIRST NAME: " << workers[n].FirstName
                 << "\n\t" << workers[n].Hours << " Hours Worked @ $" << workers[n].Payrate << " = $" << grosspay
                 << "\n\tTax Rate of " << workers[n].Taxrate*100 << "%\t\t" << taxeswithheld
                 << "\n\tEmployee Gross Pay:\t\t$" << netpay;
        }
}
*/
