    ...
    while(again == 'y')
    {
        do
        {
            cout << "\n\tMenu: "
                 ...
                 << "\n\t3 - Find a Record"
                 << "\n\t4 - Change an Existing Record's Fields"
                 << "\n\t5 - Quit";
        ...
        switch(option)
        {
            case 1:
            {
                cout << "Option 1 - Displaying All Records";
            ...
            case 4:
            {
                ...
                {
                    system("cls");
                    cout << "\n\tOption 4: Change an Existing Record's Fields"
                         << "\n\n\tSelect Students 1 - " << width << "\n\t";
                    cin >> choice;
                ...
                while(again == 'y')
                {
                    ...
                    {
                        system("cls");
                        student[choice-1].DisplayStudent();
                        cout << "\n\n\tStudent " << choice
                             << "\n\t1 - Set New ID"
                             << "\n\t2 - Set New Last Name"
                    ...
                    switch(temp)
                    {
                        ...
                        case 2:
                        {
                            cout << "\n\n\tEnter New Last Name: ";
                            getline(cin, words);
                            student[choice-1].setLast(words);
                            break;
                        }
                        case 3:
                        {
                            ...
                            getline(cin, words);
                            student[choice-1].setFirst(words);
                            break;
                        }
                        case 4:
                        {
                            ...
                            cin >> number;
                            student[choice-1].SetClasses(number);
                            break;
                        }
                        case 5:
                        {
                            cout << "\n\n\tEnter New GPA: ";
                            cin >> decimal;
                            student[choice-1].setGPA(decimal);
                            break;
                        }
                        case 6:
                        {
                            ...
                            cout << "\n\tOption 6 - Rewriting Student " << choice << "\'s Data";
                            cout << "\n\n\t(1 of 5) Enter new Student ID: ";
                            cin >> id;
                            cin.clear();
                            ...
                            student[choice-1].SetAll(id, Last, First, enrolledclasses, gpa);
                            break;
                        }
                        case 7:
                        {
