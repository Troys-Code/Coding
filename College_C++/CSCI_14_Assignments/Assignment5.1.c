...
int main( )
{
    ...
    {
    case 1:
    {   payrollcalculations(reghours, overtimehours, payrate, fedrate, staterate, option);
        cout << "\n\n\tOption 1 - Gross Pay";
    ...
    {
        payrollcalculations(reghours, overtimehours, payrate, fedrate, staterate, option);
        payrollcalculations(reghours, overtimehours, payrate, fedrate, staterate, 1);
    ...
    case 9:
    {
        for(int n = 1; n <= 8; n++)
        {
            payrollcalculations(reghours, overtimehours, payrate, fedrate, staterate, n);
        }
        cout << "\n\n\tOption 9 - All Payroll Calculations";

        cout << "\n\n\tGross Pay: $" << grosspay;
        cout << "\n\n\tFederal Taxes Withheld @ " << fedrate << "% = $" << fedtax;
        cout << "\n\n\tState Taxes Withheld @ " << staterate << "% = $" << statetax;
